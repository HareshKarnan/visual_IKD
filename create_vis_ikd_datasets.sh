...
rm /robodata/kvsikand/visualIKD/train5_data/*
roslaunch src/rosbag_sync_data_rerecorder/launch/rosbag_data_recorder.launch dataset:=train5 data_base_dir:=/robodata/ut_alphatruck_logs/visualIKD/ out_base_dir:=/robodata/kvsikand/visualIKD/
rm /robodata/kvsikand/visualIKD/train6_data/*
roslaunch src/rosbag_sync_data_rerecorder/launch/rosbag_data_recorder.launch dataset:=train6 data_base_dir:=/robodata/ut_alphatruck_logs/visualIKD/ out_base_dir:=/robodata/kvsikand/visualIKD/
rm /robodata/kvsikand/visualIKD/train7_data/*
roslaunch src/rosbag_sync_data_rerecorder/launch/rosbag_data_recorder.launch dataset:=train7 data_base_dir:=/robodata/ut_alphatruck_logs/visualIKD/ out_base_dir:=/robodata/kvsikand/visualIKD/
rm /robodata/kvsikand/visualIKD/train8_data/*
roslaunch src/rosbag_sync_data_rerecorder/launch/rosbag_data_recorder.launch dataset:=train8 data_base_dir:=/robodata/ut_alphatruck_logs/visualIKD/ out_base_dir:=/robodata/kvsikand/visualIKD/
