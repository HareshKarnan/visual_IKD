...
def get_args():
	...
	parser.add_argument('--outdoor_model', action='store_true', default=False)
	parser.add_argument('--indoor_model', action='store_true', default=False)
	...
	parser.add_argument('--train_dataset_names', nargs='+', default=['train1_data', 'train3_data', 'train5_data','train7_data', 'train9_data',
																	 'train11_data', 'train12_data','train14_data', 'train16_data',
																	 'train18_data', 'train20_data', 'train21_data', 'train22_data'])
	parser.add_argument('--val_dataset_names', nargs='+', default=['train2_data', 'train4_data', 'train6_data', 'train8_data' 'train10_data',
