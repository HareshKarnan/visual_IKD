...
def get_args():
	...
	parser.add_argument('--train_dataset_names', nargs='+', default=['train1_data', 'train3_data', 'train5_data',
																	 'train7_data', 'train9_data', 'train11_data',
																	 'train13_data', 'train15_data',
																	 'train17_data', 'train19_data', 'train21_data',
																	 'train23_data', 'train8_data', 'train10_data',
																	 'train12_data'])
	parser.add_argument('--val_dataset_names', nargs='+',
						default=['train2_data', 'train4_data', 'train6_data', 'train14_data', 'train16_data',
