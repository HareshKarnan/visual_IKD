...
def get_args():
	...
	# 							 'train23_data', 'train25_data',
	# 							 'train27_data',
	# 							 'train19_data', 'train21_data'])
	parser.add_argument('--train_dataset_names', nargs='+', default=['train1_data', 'train3_data', 'train5_data','train6_data'])
	parser.add_argument('--val_dataset_names', nargs='+', default=['train2_data', 'train4_data'])
