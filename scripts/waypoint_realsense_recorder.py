...
class WaypointRecorder:
	def __init__(self):
		self.waypoints = {}
		self.localization_sub = rospy.Subscriber('/camera/odom/sample', Odometry, self.waypoint_callback)
...
if __name__ == '__main__':
	...
	with open('waypoints_realsense.yaml', 'w') as f:
		yaml.dump(waypoint_recorder.waypoints, f)

	print('Saved waypoints to waypoints_realsense.yaml')
	exit(0)